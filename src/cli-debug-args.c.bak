 ...
 */
static char const gnutls_cli_debug_opt_strs[2009] =
/*     0 */ "gnutls-cli-debug 3.4.14\n"
            "Copyright (C) 2000-2016 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
...
/*  1001 */ "PORT\0"
/*  1006 */ "port\0"
/*  1011 */ "an alias for the 'starttls-proto' option\0"
/*  1052 */ "app-proto\0"
/*  1062 */ "The application protocol to be used to obtain the server's certificate\n"
            "(https, ftp, smtp, imap, ldap, xmpp)\0"
/*  1170 */ "STARTTLS_PROTO\0"
/*  1185 */ "starttls-proto\0"
...
/*  1340 */ "version\0"
/*  1348 */ "GNUTLS_CLI_DEBUG\0"
/*  1365 */ "gnutls-cli-debug - GnuTLS debug client\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \n\0"
/*  1463 */ "bugs@gnutls.org\0"
/*  1479 */ "\n\0"
/*  1481 */ "TLS debug client.  It sets up multiple TLS connections to a server and\n"
...
/*  1899 */ "gnutls-cli-debug 3.4.14\0"
/*  1923 */ "Usage: gnutls-cli-debug [options] hostname\n"
...
#define APP_PROTO_name    (gnutls_cli_debug_opt_strs+1052)
...
#define STARTTLS_PROTO_DESC      (gnutls_cli_debug_opt_strs+1062)
/** Upper-cased name for the starttls-proto option */
#define STARTTLS_PROTO_NAME      (gnutls_cli_debug_opt_strs+1170)
/** Name string for the starttls-proto option */
#define STARTTLS_PROTO_name      (gnutls_cli_debug_opt_strs+1185)
 ...
 */
#define HELP_DESC       (gnutls_cli_debug_opt_strs+1200)
#define HELP_name       (gnutls_cli_debug_opt_strs+1244)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (gnutls_cli_debug_opt_strs+1249)
#define MORE_HELP_name  (gnutls_cli_debug_opt_strs+1294)
...
#endif
#define VER_DESC        (gnutls_cli_debug_opt_strs+1304)
#define VER_name        (gnutls_cli_debug_opt_strs+1340)
/**
...
#define zPROGNAME       (gnutls_cli_debug_opt_strs+1348)
/** Reference to the title line for gnutls-cli-debug usage. */
#define zUsageTitle     (gnutls_cli_debug_opt_strs+1365)
...
#define zBugsAddr       (gnutls_cli_debug_opt_strs+1463)
/** Clarification/explanation of what gnutls-cli-debug does. */
#define zExplain        (gnutls_cli_debug_opt_strs+1479)
/** Extra detail explaining what gnutls-cli-debug does. */
#define zDetail         (gnutls_cli_debug_opt_strs+1481)
/** The full version string for gnutls-cli-debug. */
#define zFullVersion    (gnutls_cli_debug_opt_strs+1899)
...
#define gnutls_cli_debug_short_usage (gnutls_cli_debug_opt_strs+1923)
...
static void bogus_function(void) {
  ...
  puts(_("gnutls-cli-debug 3.4.14\n\
Copyright (C) 2000-2016 Free Software Foundation, and others, all rights reserved.\n\
This is free software. It is licensed for use, modification and\n\
redistribution under the terms of the GNU General Public License,\n\
version 3 or later <http://gnu.org/licenses/gpl.html>\n"));
