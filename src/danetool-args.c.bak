 ...
 */
static char const danetool_opt_strs[2835] =
/*     0 */ "danetool 3.5.8\n"
            "Copyright (C) 2000-2017 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
...
/*  1736 */ "STARTTLS_PROTO\0"
/*  1751 */ "starttls-proto\0"
/*  1766 */ "Whether the provided certificate or public key is a Certificate\n"
            "Authority\0"
/*  1840 */ "CA\0"
/*  1843 */ "ca\0"
/*  1846 */ "Use the hash of the X.509 certificate, rather than the public key\0"
/*  1912 */ "X509\0"
/*  1917 */ "x509\0"
/*  1922 */ "an alias for the 'domain' option\0"
/*  1955 */ "local\0"
/*  1961 */ "The provided certificate or public key is issued by the local domain\0"
/*  2030 */ "DOMAIN\0"
/*  2037 */ "no-domain\0"
/*  2047 */ "no\0"
/*  2050 */ "Use the local DNS server for DNSSEC resolving\0"
/*  2096 */ "LOCAL_DNS\0"
/*  2106 */ "no-local-dns\0"
/*  2119 */ "Do not verify any DNSSEC signature\0"
/*  2154 */ "INSECURE\0"
/*  2163 */ "insecure\0"
/*  2172 */ "Use DER format for input certificates and private keys\0"
/*  2227 */ "INDER\0"
/*  2233 */ "no-inder\0"
/*  2242 */ "an alias for the 'inder' option\0"
/*  2274 */ "inraw\0"
/*  2280 */ "Print the received DANE data in raw format\0"
/*  2323 */ "PRINT_RAW\0"
/*  2333 */ "no-print-raw\0"
/*  2346 */ "Suppress several informational messages\0"
/*  2386 */ "QUIET\0"
/*  2392 */ "quiet\0"
/*  2398 */ "display extended usage information and exit\0"
/*  2442 */ "help\0"
/*  2447 */ "extended usage information passed thru pager\0"
/*  2492 */ "more-help\0"
/*  2502 */ "output version information and exit\0"
/*  2538 */ "version\0"
/*  2546 */ "DANETOOL\0"
/*  2555 */ "danetool - GnuTLS DANE tool\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  2641 */ "bugs@gnutls.org\0"
/*  2657 */ "\n\0"
/*  2659 */ "Tool to generate and check DNS resource records for the DANE protocol.\n\0"
/*  2731 */ "danetool 3.5.8\0"
/*  2746 */ "danetool --[tlsa-rr|check] [options]\n"
...
#define STARTTLS_PROTO_NAME      (danetool_opt_strs+1736)
/** Name string for the starttls-proto option */
#define STARTTLS_PROTO_name      (danetool_opt_strs+1751)
...
#define CA_DESC      (danetool_opt_strs+1766)
/** Upper-cased name for the ca option */
#define CA_NAME      (danetool_opt_strs+1840)
/** Name string for the ca option */
#define CA_name      (danetool_opt_strs+1843)
...
#define X509_DESC      (danetool_opt_strs+1846)
/** Upper-cased name for the x509 option */
#define X509_NAME      (danetool_opt_strs+1912)
/** Name string for the x509 option */
#define X509_name      (danetool_opt_strs+1917)
...
#define LOCAL_DESC    (danetool_opt_strs+1922)
#define LOCAL_NAME    NULL
/** Unmodified name string for the local option */
#define LOCAL_name    (danetool_opt_strs+1955)
...
#define DOMAIN_DESC      (danetool_opt_strs+1961)
/** Upper-cased name for the domain option */
#define DOMAIN_NAME      (danetool_opt_strs+2030)
/** disablement name for the domain option */
#define NOT_DOMAIN_name  (danetool_opt_strs+2037)
/** disablement prefix for the domain option */
#define NOT_DOMAIN_PFX   (danetool_opt_strs+2047)
...
#define LOCAL_DNS_DESC      (danetool_opt_strs+2050)
/** Upper-cased name for the local-dns option */
#define LOCAL_DNS_NAME      (danetool_opt_strs+2096)
/** disablement name for the local-dns option */
#define NOT_LOCAL_DNS_name  (danetool_opt_strs+2106)
/** disablement prefix for the local-dns option */
#define NOT_LOCAL_DNS_PFX   (danetool_opt_strs+2047)
...
#define INSECURE_DESC      (danetool_opt_strs+2119)
/** Upper-cased name for the insecure option */
#define INSECURE_NAME      (danetool_opt_strs+2154)
/** Name string for the insecure option */
#define INSECURE_name      (danetool_opt_strs+2163)
...
#define INDER_DESC      (danetool_opt_strs+2172)
/** Upper-cased name for the inder option */
#define INDER_NAME      (danetool_opt_strs+2227)
/** disablement name for the inder option */
#define NOT_INDER_name  (danetool_opt_strs+2233)
/** disablement prefix for the inder option */
#define NOT_INDER_PFX   (danetool_opt_strs+2047)
...
#define INRAW_DESC    (danetool_opt_strs+2242)
#define INRAW_NAME    NULL
/** Unmodified name string for the inraw option */
#define INRAW_name    (danetool_opt_strs+2274)
...
#define PRINT_RAW_DESC      (danetool_opt_strs+2280)
/** Upper-cased name for the print-raw option */
#define PRINT_RAW_NAME      (danetool_opt_strs+2323)
/** disablement name for the print-raw option */
#define NOT_PRINT_RAW_name  (danetool_opt_strs+2333)
/** disablement prefix for the print-raw option */
#define NOT_PRINT_RAW_PFX   (danetool_opt_strs+2047)
...
#define QUIET_DESC      (danetool_opt_strs+2346)
 ...
 */
#define HELP_DESC       (danetool_opt_strs+2398)
#define HELP_name       (danetool_opt_strs+2442)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (danetool_opt_strs+2447)
#define MORE_HELP_name  (danetool_opt_strs+2492)
...
#endif
#define VER_DESC        (danetool_opt_strs+2502)
#define VER_name        (danetool_opt_strs+2538)
/**
...
#define zPROGNAME       (danetool_opt_strs+2546)
/** Reference to the title line for danetool usage. */
#define zUsageTitle     (danetool_opt_strs+2555)
...
#define zBugsAddr       (danetool_opt_strs+2641)
/** Clarification/explanation of what danetool does. */
#define zExplain        (danetool_opt_strs+2657)
/** Extra detail explaining what danetool does. */
#define zDetail         (danetool_opt_strs+2659)
/** The full version string for danetool. */
#define zFullVersion    (danetool_opt_strs+2731)
...
#define danetool_short_usage (danetool_opt_strs+2746)
