 ...
 */
static char const danetool_opt_strs[2830] =
/*     0 */ "danetool 3.4.14\n"
            "Copyright (C) 2000-2016 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
...
/*  1561 */ "PORT\0"
/*  1566 */ "port\0"
/*  1571 */ "an alias for the 'starttls-proto' option\0"
/*  1612 */ "app-proto\0"
/*  1622 */ "The application protocol to be used to obtain the server's certificate\n"
            "(https, ftp, smtp, imap, ldap, xmpp)\0"
/*  1730 */ "STARTTLS_PROTO\0"
/*  1745 */ "starttls-proto\0"
/*  1760 */ "Whether the provided certificate or public key is a Certificate\n"
            "Authority\0"
/*  1834 */ "CA\0"
/*  1837 */ "ca\0"
/*  1840 */ "Use the hash of the X.509 certificate, rather than the public key\0"
/*  1906 */ "X509\0"
/*  1911 */ "x509\0"
/*  1916 */ "an alias for the 'domain' option\0"
/*  1949 */ "local\0"
/*  1955 */ "The provided certificate or public key is issued by the local domain\0"
/*  2024 */ "DOMAIN\0"
/*  2031 */ "no-domain\0"
/*  2041 */ "no\0"
/*  2044 */ "Use the local DNS server for DNSSEC resolving\0"
/*  2090 */ "LOCAL_DNS\0"
/*  2100 */ "no-local-dns\0"
/*  2113 */ "Do not verify any DNSSEC signature\0"
/*  2148 */ "INSECURE\0"
/*  2157 */ "insecure\0"
/*  2166 */ "Use DER format for input certificates and private keys\0"
/*  2221 */ "INDER\0"
/*  2227 */ "no-inder\0"
/*  2236 */ "an alias for the 'inder' option\0"
/*  2268 */ "inraw\0"
/*  2274 */ "Print the received DANE data in raw format\0"
/*  2317 */ "PRINT_RAW\0"
/*  2327 */ "no-print-raw\0"
/*  2340 */ "Suppress several informational messages\0"
/*  2380 */ "QUIET\0"
/*  2386 */ "quiet\0"
/*  2392 */ "display extended usage information and exit\0"
/*  2436 */ "help\0"
/*  2441 */ "extended usage information passed thru pager\0"
/*  2486 */ "more-help\0"
/*  2496 */ "output version information and exit\0"
/*  2532 */ "version\0"
/*  2540 */ "DANETOOL\0"
/*  2549 */ "danetool - GnuTLS DANE tool\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  2635 */ "bugs@gnutls.org\0"
/*  2651 */ "\n\0"
/*  2653 */ "Tool to generate and check DNS resource records for the DANE protocol.\n\0"
/*  2725 */ "danetool 3.4.14\0"
/*  2741 */ "danetool --[tlsa-rr|check] [options]\n"
...
#define APP_PROTO_name    (danetool_opt_strs+1612)
...
#define STARTTLS_PROTO_DESC      (danetool_opt_strs+1622)
/** Upper-cased name for the starttls-proto option */
#define STARTTLS_PROTO_NAME      (danetool_opt_strs+1730)
/** Name string for the starttls-proto option */
#define STARTTLS_PROTO_name      (danetool_opt_strs+1745)
...
#define CA_DESC      (danetool_opt_strs+1760)
/** Upper-cased name for the ca option */
#define CA_NAME      (danetool_opt_strs+1834)
/** Name string for the ca option */
#define CA_name      (danetool_opt_strs+1837)
...
#define X509_DESC      (danetool_opt_strs+1840)
/** Upper-cased name for the x509 option */
#define X509_NAME      (danetool_opt_strs+1906)
/** Name string for the x509 option */
#define X509_name      (danetool_opt_strs+1911)
...
#define LOCAL_DESC    (danetool_opt_strs+1916)
#define LOCAL_NAME    NULL
/** Unmodified name string for the local option */
#define LOCAL_name    (danetool_opt_strs+1949)
...
#define DOMAIN_DESC      (danetool_opt_strs+1955)
/** Upper-cased name for the domain option */
#define DOMAIN_NAME      (danetool_opt_strs+2024)
/** disablement name for the domain option */
#define NOT_DOMAIN_name  (danetool_opt_strs+2031)
/** disablement prefix for the domain option */
#define NOT_DOMAIN_PFX   (danetool_opt_strs+2041)
...
#define LOCAL_DNS_DESC      (danetool_opt_strs+2044)
/** Upper-cased name for the local-dns option */
#define LOCAL_DNS_NAME      (danetool_opt_strs+2090)
/** disablement name for the local-dns option */
#define NOT_LOCAL_DNS_name  (danetool_opt_strs+2100)
/** disablement prefix for the local-dns option */
#define NOT_LOCAL_DNS_PFX   (danetool_opt_strs+2041)
...
#define INSECURE_DESC      (danetool_opt_strs+2113)
/** Upper-cased name for the insecure option */
#define INSECURE_NAME      (danetool_opt_strs+2148)
/** Name string for the insecure option */
#define INSECURE_name      (danetool_opt_strs+2157)
...
#define INDER_DESC      (danetool_opt_strs+2166)
/** Upper-cased name for the inder option */
#define INDER_NAME      (danetool_opt_strs+2221)
/** disablement name for the inder option */
#define NOT_INDER_name  (danetool_opt_strs+2227)
/** disablement prefix for the inder option */
#define NOT_INDER_PFX   (danetool_opt_strs+2041)
...
#define INRAW_DESC    (danetool_opt_strs+2236)
#define INRAW_NAME    NULL
/** Unmodified name string for the inraw option */
#define INRAW_name    (danetool_opt_strs+2268)
...
#define PRINT_RAW_DESC      (danetool_opt_strs+2274)
/** Upper-cased name for the print-raw option */
#define PRINT_RAW_NAME      (danetool_opt_strs+2317)
/** disablement name for the print-raw option */
#define NOT_PRINT_RAW_name  (danetool_opt_strs+2327)
/** disablement prefix for the print-raw option */
#define NOT_PRINT_RAW_PFX   (danetool_opt_strs+2041)
...
#define QUIET_DESC      (danetool_opt_strs+2340)
/** Upper-cased name for the quiet option */
#define QUIET_NAME      (danetool_opt_strs+2380)
/** Name string for the quiet option */
#define QUIET_name      (danetool_opt_strs+2386)
 ...
 */
#define HELP_DESC       (danetool_opt_strs+2392)
#define HELP_name       (danetool_opt_strs+2436)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (danetool_opt_strs+2441)
#define MORE_HELP_name  (danetool_opt_strs+2486)
...
#endif
#define VER_DESC        (danetool_opt_strs+2496)
#define VER_name        (danetool_opt_strs+2532)
/**
...
#define zPROGNAME       (danetool_opt_strs+2540)
/** Reference to the title line for danetool usage. */
#define zUsageTitle     (danetool_opt_strs+2549)
...
#define zBugsAddr       (danetool_opt_strs+2635)
/** Clarification/explanation of what danetool does. */
#define zExplain        (danetool_opt_strs+2651)
/** Extra detail explaining what danetool does. */
#define zDetail         (danetool_opt_strs+2653)
/** The full version string for danetool. */
#define zFullVersion    (danetool_opt_strs+2725)
...
#define danetool_short_usage (danetool_opt_strs+2741)
